...
For this we will be using another dataset, this time from the psychological sciences. Let's look at the effect of behaviour automaticity using the Stroop task. You can try the Stroop yourself [here](https://www.psytoolkit.org/experiment-library/experiment_stroop.html)
