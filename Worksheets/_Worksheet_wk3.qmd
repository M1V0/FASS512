...
Let us run the following command, notice the function is `read.csv` with a dot, not an underscore (look back at worksheet 2 to see why)


```{r}

read_csv('nettle_1999_climate.csv')
...
```{r}
languages # remember we created this earlier
```
